...
export default function Solarmodule() {
	...
	async function fetchProducts(e) {
		try {
			...
			const req = await fetch("/api/hello", {
				...
				method: "POST",
				body: JSON.stringify({ params: `Solarmodule PV Anlage` }),
			});
	...
	return (
		<div className=" w-full min-h-screen">
			<HeadMeta
				title="Solaranlage für unterwegs - die richtige Wahl für Ihr Zuhause"
				description="Die neue Solaranlage – flexibel, leistungsstark und für jeden Bedarf die richtige. Jetzt informieren und bestellen."
			/>

			<div className="container mx-auto py-32">
				<h1 className="text-biggest text-center font-semibold">
					Günstige <span className="text-neon">Solarmodule</span> für deine
					<br />
					Solaranlage finden!
				</h1>
			</div>
