...
export default function Kabel() {
	...
	async function fetchProducts(e) {
		try {
			...
			const req = await fetch("/api/hello", {
				...
				method: "POST",
				body: JSON.stringify({ params: `Kabel PV Anlage` }),
			});
	...
	return (
		<div className=" w-full min-h-screen">
			<HeadMeta
				title="Welches Solaranlage Kabel Zubehör ist das Richtige für Sie?"
				description="Jetzt die perfekte Solaranlage kabel zubehör auswählen und kaufen! ✓Top Auswahl ✓günstige Preise ✓schneller Versand."
			/>
