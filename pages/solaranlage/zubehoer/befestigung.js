...
export default function Befestigung() {
	...
	return (
		<div className=" w-full min-h-screen">
			<HeadMeta
				title="Jetzt die beste Solaranlage Befestigung kaufen"
				description="Kaufe jetzt die beste Solaranlage Befestigung auf dem Markt! Schnelle Lieferung und garantierte Qualität!"
			/>
