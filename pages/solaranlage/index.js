...
const FAQ_DATA = [
	...
	{
		title: "Solaranlage für den Balkon – Preise vergleichen und kaufen ",
		content:
			"Wenn Sie sich für eine Solaranlage für Ihren Balkon entscheiden, sollten Sie zunächst verschiedene Modelle und Preise vergleichen. Denn nur so können Sie die beste Anlage zu einem günstigen Preis erwerben. Auf dieser Seite finden Sie einen Preisvergleich verschiedener Solaranlagen für den Balkon. So können Sie schnell und einfach die beste Anlage zum günstigsten Preis erwerben. Solaranlage für den Balkon – Modelle vergleichen Wenn Sie eine Solaranlage für Ihren Balkon kaufen möchten, sollten Sie zunächst verschiedene Modelle vergleichen. Denn nur so können Sie die beste Anlage zu einem günstigen Preis erwerben. Auf dieser Seite finden Sie einen Vergleich verschiedener Solaranlagen-Modelle. So können Sie schnell und einfach die beste Anlage zum günstigsten Preis erwerben.",
	},
];

const QUERY_VARS =
	process.env.NODE_ENV === "production"
		? "?amdata=enc%3AAQAHAAAAoD6xcFatNtZNTBC99reD4H2PpIaEZfJAHB%2BVed0PKMeFnIv6eRphAQBBPBr4WBw22L3ONvwBYBpJhJqx3MAH1pweDz%2BNq%2FdP1YKN2kESdAhgmAtFomnwD85dTTXdBoBMn2L96NxclXvVkdN1rXVkkjGR7o2XI5ymZiLWkY9%2Bey7O8N4ZxIAEqmKUs0j2lIdiBfUx0kJf9Q9%2BrW0mCrt%2Bku8%3D&mkcid=1&mkrid=707-53477-19255-0&siteid=77&campid=5338952852&customid=&toolid=10001&mkevt=1"
		: "";

export default function Solaranlage() {
	...
	async function fetchProducts(e) {
		try {
			...
			const req = await fetch("/api/hello", {
				...
				method: "POST",
				body: JSON.stringify({ params: `Balkonkraftwerk` }),
			});
		...
		<div className=" w-full min-h-screen">
			...
			<div className="container mx-auto py-32">
				<h1 className="text-biggest text-center font-semibold">
					Preisvergleich: <span className="text-neon">Solaranlagen</span>
					<br />
